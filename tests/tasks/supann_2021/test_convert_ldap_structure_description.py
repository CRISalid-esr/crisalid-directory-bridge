...
TESTED_TASK_NAME = 'tasks.supann_2021.convert_ldap_structure_description' \
                   '.convert_ldap_structure_description_task'

TEST_TASK_ID = "convert_ldap_structure_description_task"
...
@pytest.mark.parametrize("dag", [
    {
        ...
        'ldap_results': {
            "dn": "uid=3456,ou=people,dc=example,dc=org",
            "entry": {
    ...
    },
    {
        'task_name': TESTED_TASK_NAME,
        'ldap_results': {
            "dn": "uid=6789,ou=people,dc=example,dc=org",
            "entry": {
